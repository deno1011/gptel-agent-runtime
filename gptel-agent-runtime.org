...
* Experimental Planner Loop and Feature Provide

Observe/plan/act/reflect scaffolding for autonomous agent sessions, final model selection after helpers are available, and package feature provide. This is early infrastructure, not yet a fully reliable agent runtime.
