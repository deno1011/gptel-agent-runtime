...
* gptel Base Setup and Backend Registration

Installs/configures gptel, loads provider modules, registers cloud and local backends, starts/selects Ollama, and prefers the currently active Ollama model when available.
