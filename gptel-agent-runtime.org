...
The executor watches gptel responses, runs Org Babel and AUTORUN blocks, executes file-output blocks for inline images, and repairs some tutorial-style local-model plot responses. The claude-executor prefix remains for compatibility.
