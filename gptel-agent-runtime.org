...
Clipboard image capture, shrinking, org-download integration, and attaching images to gptel context.
...
HTTP fetch, readable text extraction, DuckDuckGo HTML search, image extraction/download, and inline image insertion helpers.
