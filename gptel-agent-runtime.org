...
* Prompt Directives and Runtime Defaults

gptel directives for local assistant, planner, and full assistant modes, plus executor defaults and Babel language activation. Prompt strings contain nested Org examples, so those lines are comma-escaped in this literate source and unescaped during tangling.
