#+TITLE: gar-substrate: Runtime tick + event pump + provenance + versioned state
#+PROPERTY: header-args:emacs-lisp :tangle gar-substrate.el :lexical t

Module of [[file:gptel-agent-runtime.org][gptel-agent-runtime]]. Owns the runtime substrate that
...
- =gptel-agent-runtime--advance-tick=: Advance the runtime substrate tick counter.
...
- =gptel-agent-runtime-toggle-idle-pump=: Toggle the runtime substrate idle pump.
