...
- /Workspace context collectors/: =my/collect-org-todos=,
  =my/build-workspace-context=, =my/workspace-context-string=,
  =my/gptel-context-invalidate=, plus the gptel-send advice
