...
This module is the optional model-backed skeptic path.

- `gptel-agent-runtime--skeptic-system-prompt' defines the reviewer role.
- `gptel-agent-runtime--skeptic-build-prompt' serializes the proposed step for review.
- `gptel-agent-runtime--skeptic-model-based-verdict' performs the synchronous model request.
- `gptel-agent-runtime--skeptic-extract-json-object' and `gptel-agent-runtime--skeptic-parse-verdict' normalize the response back into the stable verdict shape consumed by `gar-skeptic'.
