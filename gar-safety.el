;;; gar-safety.el --- policy broker, capability gate, skeptic, quarantine, canaries, mission-control -*- lexical-binding: t; -*-
...
;; per-source quarantine, Advocatus Diaboli skeptic, prompt-injection
;; canaries, policy presets, and the mission-control unified
;; dashboard.
;;
