;;; gar-safety.el --- policy broker, capability gate, mission-control -*- lexical-binding: t; -*-
...
;; policy broker, capability gate, untrusted-context wrappers, policy
;; presets, and the mission-control unified dashboard. Prompt-injection
;; canaries, per-source quarantine, and the Advocatus Diaboli skeptic
;; were extracted to gar-canaries, gar-quarantine, and gar-skeptic on
;; 2026-05-27.
;;
...
;; Skeptic symbols now live in gar-skeptic (loaded before gar-safety).
