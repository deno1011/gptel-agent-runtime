...
- /Compatibility glue/: =my/gptel-tools-all=, =my/gptel-sync-tools=,
  =my/gptel-select-model=, =my/gptel-mode-line=, =my/gptel-status=,
  =my/gptel-sync-and-status=, the C-c bindings for status/select.
